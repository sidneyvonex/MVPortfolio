...
export default function SettingsPanel() {
  ...
  const resumePreviewUrl = `${import.meta.env.VITE_API_URL || '/api'}/settings/resume/download?mode=inline`;
            ...
            {settings.resumeUrl && (
              <div className="flex flex-col gap-2">
                <div className="flex items-center justify-between">
                  ...
                  <a href={resumePreviewUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 text-[#1A56FF] text-xs hover:underline">
